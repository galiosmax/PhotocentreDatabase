...
class BranchOfficeController(val executor: Executor) : Controller() {
    //var offices = mutableListOf<BranchOffice>()
    //
...
//
    ...
    fun updateBranchOffice(newOffice: BranchOffice) {
        ...
        //offices = FXCollections.observableArrayList(executor.getAllBranchOffices())
    }
